...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Loading " + (thePercent+0)+"%";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Em ấn vào đây phải hông !';
document.querySelector('.Description .modal-body').innerHTML = 'hihi <i class="fas fa-heart"></i> ';
